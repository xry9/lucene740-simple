...
public final class TrackingDirectoryWrapper extends FilterDirectory {
  ...
  public TrackingDirectoryWrapper(Directory in) {
    super(in);
    //System.out.println("===TrackingDirectoryWrapper===33==="+in);
  }
  @Override
  ...
  public IndexOutput createOutput(String name, IOContext context) throws IOException {
    ...
    System.out.println("===createdFileNames===45==="+name);
    return output;
  }
  @Override
  public IndexOutput createTempOutput(String prefix, String suffix, IOContext context)
    ...
    System.out.println("===createdFileNames===53==="+tempOutput.getName());
    return tempOutput;
  }
  @Override
  public void copyFrom(Directory from, String src, String dest, IOContext context) throws IOException {
    ...
    System.out.println("===createdFileNames===60==="+dest);
  }
  @Override
  ...
  public Set<String> getCreatedFiles() {
    System.out.println("===getCreatedFiles===73==="+createdFileNames);//try{ Integer.parseInt("getCreatedFiles"); }catch (Exception e){e.printStackTrace();}
